...
CHOREOGRAPHY = [
    ...
    pose(spine=(0, -4, 0), knee_l=(0, 10, 0), knee_r=(0, 22, 0), leg_r=(0, -6, 0)),  # 0  준비 (오른쪽에 무게)
    pose(arm_r=(0, -15, 60), fore_r=(0, 0, 10), arm_l=(0, -20, -65), fore_l=(0, 0, 25),
         spine=(0, 0, -12), chest=(0, 0, -8), head=(0, 0, -6),
         leg_l=(0, -45, 4), knee_l=(0, 75, 0), knee_r=(0, 8, 0)),                    # 1  오른팔 위 + 왼무릎 들기
    pose(arm_l=(0, -15, 60), fore_l=(0, 0, 10), arm_r=(0, -20, -65), fore_r=(0, 0, 25),
         spine=(0, 0, 12), chest=(0, 0, 8), head=(0, 0, 6),
         leg_r=(0, -45, 4), knee_r=(0, 75, 0), knee_l=(0, 8, 0)),                    # 2  왼팔 위 + 오른무릎 들기
    ...
    pose(arm_l=(0, -85, -8), arm_r=(0, -85, -8), fore_l=(0, 0, 5), fore_r=(0, 0, 5),
         ...
         leg_l=(0, -14, 0), leg_r=(0, -14, 0), knee_l=(0, 30, 0), knee_r=(0, 30, 0)),  # 3  앞으로 뻗기 + 무릎 굽힘
    ...
    pose(arm_l=(0, 5, 48), arm_r=(0, 5, 48), fore_l=(0, 0, 8), fore_r=(0, 0, 8),
         ...
         leg_l=(0, 0, 20), leg_r=(0, 0, 20), knee_l=(0, 6, 0), knee_r=(0, 6, 0)),    # 4  V + 젖힘 + 다리 벌림
    ...
    pose(spine=(28, 0, 0), chest=(16, 0, 0),
         ...
         head=(0, 0, 8),
         leg_r=(0, -38, 10), knee_r=(0, 62, 0), knee_l=(0, 12, 0)),                  # 9  몸통 오른쪽 + 오른무릎
    pose(spine=(-28, 0, 0), chest=(-16, 0, 0),
         arm_r=(0, -70, -10), fore_r=(0, 0, 50), arm_l=(0, 25, -45), fore_l=(0, 0, 15),
         head=(0, 0, -8),
         leg_l=(0, -38, 10), knee_l=(0, 62, 0), knee_r=(0, 12, 0)),                  # 10 몸통 왼쪽 + 왼무릎
    ...
    pose(leg_l=(0, -8, 32), leg_r=(0, 0, 26), knee_l=(0, 52, 0), knee_r=(0, 14, 0),
         ...
         arm_l=(0, -20, -78), fore_l=(0, 0, 20), arm_r=(0, -10, -30), fore_r=(0, 0, 10)),  # 11 런지 (왼무릎 깊게)
    ...
    pose(arm_l=(0, -10, 62), fore_l=(0, 0, 10), arm_r=(0, 10, -72), fore_r=(0, 0, 22),
         ...
         leg_l=(0, 0, 24), leg_r=(0, -12, 0), knee_r=(0, 34, 0), knee_l=(0, 8, 0)),  # 16 대각선 + 무게 오른쪽
